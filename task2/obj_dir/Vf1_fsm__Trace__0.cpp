...
void Vf1_fsm___024root__trace_chg_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,((((((((((0U == vlSelf->f1_fsm__DOT__current_state) 
                             ...
                             : ((8U == vlSelf->f1_fsm__DOT__current_state)
                                 ? 0xffU : 0U))),8);
    bufp->chgIData(oldp+5,(vlSelf->f1_fsm__DOT__current_state),32);
    bufp->chgIData(oldp+6,(vlSelf->f1_fsm__DOT__next_state),32);
}
