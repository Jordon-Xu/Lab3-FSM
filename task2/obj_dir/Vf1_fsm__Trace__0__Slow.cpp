...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+7,"next_state", false,-1, 31,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,((((((((((0U == vlSelf->f1_fsm__DOT__current_state) 
                              ...
                              : ((8U == vlSelf->f1_fsm__DOT__current_state)
                                  ? 0xffU : 0U))),8);
    bufp->fullIData(oldp+6,(vlSelf->f1_fsm__DOT__current_state),32);
    bufp->fullIData(oldp+7,(vlSelf->f1_fsm__DOT__next_state),32);
}
